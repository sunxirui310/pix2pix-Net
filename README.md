...
- Clone this repo:
```bash
git clone https://github.com/sunxirui310/pix2pix-Net.git
cd pix2pix-Net
```
...
## Acknowledgments
Code borrows heavily from [pix2pix](https://github.com/phillipi/pix2pix) and [DCGAN-tensorflow](https://github.com/carpedm20/DCGAN-tensorflow/blob/master/model.py) and [pix2pix net](https://github.com/yenchenlin/pix2pix-tensorflow)
